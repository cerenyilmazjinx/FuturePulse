...
#[derive(Debug)]
pub struct FuturePulseProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FuturePulseProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FuturePulse processing");
    
    let mut processor = FuturePulseProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FuturePulseProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FuturePulseProcessor::new(false);
